  ...
  "Help and contact view" must {
    ...
    "have correct links" when {
      ...
      val linksToValidate = Seq(
        ("Help with your business tax account", "/business-account/help/help-with-your-business-tax-account"),
        ("Change contact and account details", "/business-account/help/change-your-details"),
        ("How to add a tax", "/business-account/help/how-to-add-tax"),
        ("Payments and penalties", "/business-account/help/self-assessment/payment-and-penalties"),
        ("Registering or stopping", "/business-account/help/self-assessment/register-or-stopping"),
        ("Help with SA tax return", "/business-account/help/self-assessment/help-with-return"),
        ("Get evidence of income - SA302", "/business-account/help/self-assessment/evidence-of-income"),
        ("Expenses", "/business-account/help/self-assessment/expenses"),
        ...
        ("Register or deregister", "/business-account/help/vat/register-or-deregister"),
        ("How to pay and deadlines", "/business-account/help/vat/how-to-pay"),
        ("Correcting errors on returns","/business-account/help/correcting-errors-on-returns"),
        ("Get started", "/business-account/help/epaye/get-started"),
        ("View or correct your submissions", "/business-account/help/view-check-correct-submissions"),
        ("PAYE and CIS refunds", "/business-account/help/refunds"),
        ("Changes in employee circumstances", "/business-account/help/epaye/change-employee-circumstances"),
        ("If you stop being an employer", "/business-account/help/stop-being-an-employer"),
        ("Register or add Corporation Tax","/business-account/help/register-add-corporation-tax"),
        ("Closing a limited company", "/business-account/help/closing-limited-company"),
        ("Get a copy of your Unique Taxpayer Reference (UTR)", "/business-account/help/ask-for-copy-of-your-corporation-tax-utr"),
        ("Contact HMRC", "/business-account/help/corporation-tax/contact-hmrc")
      )
